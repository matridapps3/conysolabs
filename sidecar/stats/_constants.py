"""Shewhart control chart constants for subgroup sizes 2..25.
Sources: ASTM E2587, AIAG SPC manual."""

# Index 0 = subgroup size 2.
...
# Standard-deviation Shewhart constants (for Xbar-S charts). Sized 2..25.
# A3 widens the Xbar limits; B3 / B4 bound the s chart; c4 is the unbiasing
# constant relating s̄ to σ (s̄ / c4 → σ̂).
...
def n_to_idx(n: int) -> int:
    if n < 2 or n > 25:
        raise ValueError(f"subgroup size must be in [2,25], got {n}")
    return n - 2
